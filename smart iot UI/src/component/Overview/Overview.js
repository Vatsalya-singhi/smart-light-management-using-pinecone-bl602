...
const Overview = () => {
    ...
    const fetchPlaceList = async () => {
        try {
            const response = await axios.get('http://localhost:3000/iot_dumps/place_id_list');
    ...
    const fetchDeviceList = async () => {
        try {
            const response = await axios.get('http://localhost:3000/iot_dumps/device_name_list');
